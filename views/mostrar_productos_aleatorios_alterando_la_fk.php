...
$productos = $daoProducto->getRandomFK($_GET["columnaCategoria"], $_GET["limite"]);
?>
...
<body>
	...
	<h1>GetRandomFK</h1>
	<h3>Permite obtener una cantidad determinada de registros y de forma aleatoria, pero cambiando la clave foranea (Mostrar otra columna de la tabla agena, en lugar de su clave primaria), si no se entregan parámetros al método se muestran las claves primarias por defecto</h3>
