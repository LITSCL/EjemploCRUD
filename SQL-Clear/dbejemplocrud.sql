...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-12-2023 a las 22:15:21
...
--
-- Base de datos: `dbejemplocrud`
--
CREATE DATABASE IF NOT EXISTS `dbejemplocrud` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dbejemplocrud`;
